...
# The CRSP® Stocks and SPGMI Factors Data Sets {#the-crsp-stocks-and-spgmi-factors-data-sets}

## The stocksCRSPmonthly Data Set {the-stocks-crsp-monthly-data-set}
...
## The factorsSPGMIr Data Set {the-factors-spgmir-data-set}
...
## Manipulating a data.table {manipulating-a-data-table}
...
# Selecting CRSP® Stocks and SPGMI Factors Data {selecting-crsp-stocks-and-spgmi-factors-data}
...
3.  When the parameter `factorPrecision = “rounded”` is used, the function will select factor data from the rounded `factorsSPGMIr` data set. Setting this parameter to “not_rounded” will use the full precision factors SPGMI data available in both the `DataPlus` folder of the PCRA package, as described in [<u>Using Weekly and Daily CRSP® Data and Unrounded SPGMI Data</u>](#using-weekly-and-daily-crsp-data-and-unrounded-spgmi-data), and in the development version of `PCRA` (assuming the user has the development version installed and loaded).
...
## Manipulation of xts Objects {manipulation-of-xts-objects}
...
## A Simple Selection Function for CRSP® Stocks Data {a-simple-selection-function-for-crsp-stocks-data}
...
# Using Weekly and Daily CRSP® Data and Unrounded SPGMI Data {using-weekly-and-daily-crsp-data-and-unrounded-spgmi-datat}
...
# Basic Data.Table Manipulations {basic-data-table-manipulations}
...
## Sector and Capitalization Group Counts {sector-and-capitalization-group-counts}
...
## Intersecting Sector and Size Groupings {intersecting-sector-and-size-groupings}
...
## Selecting a Time Range for a Set of Stocks and Factors {selecting-a-time-range}
...
# CRSP® Stocks Market Capitalization Break Points {crsp-stocks-market-capitalization-break-points}
...
# Names of CRSP® Items in stocksCRSPmonthly Data Set {names-of-crsp-items-in-stockscrspmonthly-data-set}
