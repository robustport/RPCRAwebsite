...
![Returns of the first 4 CRSP® microcap stocks, the Market, and the Risk-Free rate from 1997 to 2010](vignette-assets/stocksMicroAll.png){#fig-microcap-mkt-rf-returns}
...
![Boxplots of cross-sections of CRSP® stock returns excess kurtosis (eKR) for 6 contiguous time intervals](vignette-assets/eKRstocksMonthly.png){#fig-microcap-mkt-rf-returns}
...
![Time series of weekly returns for the first 5 of the 34 MicroCap CRSP® stocks, and the CRSP® Market returns](vignette-assets/weeklyStockReturns.png){#fig-weekly-returns-5-microcap-stocks}
