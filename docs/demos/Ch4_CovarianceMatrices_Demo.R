...
## The Ch 2 comments in the lines below indicate that these packages may have
## been installed to run the Ch 2 demo code, and in that case they needn't be
...
## 4. Finally, install the FactorAnalytics and covmat packages
...
returnsAll <- PCRA::selectCRSPandSPGMI(periodicity = "weekly",
                                        dateRange = dateRange,
                                        stockItems = stockItems, 
                                        factorItems = NULL, 
                                        subsetType = "CapGroupLast",
...
PCRA::tsPlotMP(returns, layout = c(2,10))
...
####  NOTE: The code below takes about 2.0 minutes on a fast computer
